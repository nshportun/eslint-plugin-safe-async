...
- Corrected npm badge URL to use proper percent-encoding for scoped package name
- Fixed homepage field to point to GitHub repository

## [0.1.1] - 2026-06-24

### Fixed

- Aligned README install command and badge to published scoped package name
- Corrected import examples in docs and examples directory
